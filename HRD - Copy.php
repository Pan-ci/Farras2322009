...
echo "<br>Selamat datang, Admin " . $_SESSION['username'] . "!<br>";
...
?></div>
    <div class="containerBeranda">
        <div class="column">
            <a href="Laporan Harian Kehadiran Karyawan/index - Copy.php" class="box" onclick="alert('Membuka halaman Laporan Kehadiran Harian!')"> <!--event click, fungsi js kotak dialog, ok u/ tutup-->
                <img src="download (1).jpeg" alt="daftar" class="box-image">
                <div class="box-text">
                <h2>Laporan<br>Kehadiran<br>Harian</h2>
                </div>
            </a>
            <a href="Daftar Karyawan/index - Copy.php" class="box" onclick="alert('Membuka halaman Daftar Karyawan!')"> <!--event click, fungsi js kotak dialog, ok u/ tutup-->
            <img src="download (1).jpeg" alt="daftar" class="box-image">
            <div class="box-text">
            <h2>Daftar Karyawan</h2>
            </div>
        </a>
        <a href= "Data Jabatan/index - Copy.php" class="box" onclick="alert('Membuka halaman Data Jabatan!')">
            <img src="download.png" alt="daftar" class="box-image">
            <div class="box-text">
            <h2>Data Jabatan</h2>
            </div>
        </a>
        <a href= "Data Admin/index - Copy.php" class="box" onclick="alert('Membuka halaman Data Admin!')"> <!--dengan link dan alert, bisa di set ke return false;-->
        ...
        <div class="column">
            <a href="Laporan Gaji Bulanan Karyawan/index - Copy.php" class="box" onclick="alert('Membuka halaman Laporan Gaji Bulanan!')"> <!--dengan link dan alert, bisa di set ke return false;-->
                <img src="images.jpeg" alt="daftar" class="box-image">
                <div class="box-text">
                <h2>Laporan<br>Gaji<br>Bulanan</h2>
                </div>
            </a>    
        <a href="Data Gaji/index - Copy.php" class="box" onclick="alert('Membuka halaman Data Gaji!')"> <!--dengan link dan alert, bisa di set ke return false;-->
            <img src="images.jpeg" alt="daftar" class="box-image">
            <div class="box-text">
            <h2>Data Gaji</h2>
            </div>
        </a>
        <a href="Data Departemen/index - Copy.php" class="box" onclick="alert('Membuka halaman Data Departemen!')">
            <img src="Grading-2018-1.png" alt="daftar" class="box-image">
            <div class="box-text">
            <h2>Data Departemen</h2>
            </div>
        </a>
        <a href="Status Kehadiran/index - Copy.php" class="box" onclick="alert('Membuka halaman Status Kehadiran!')">
            <img src="Grading-2018-1.png" alt="daftar" class="box-image">
            <div class="box-text">
            <h2>Status Hadir</h2>
            </div>
